<template>
  <div class="home-instructions">
    ...
    <div class="home-instructions__block">
      ...
      <p>
        <strong>
          Please read all instructions carefully before you begin to work on the exercise.
        </strong>
      </p>
      ...
      <InfoBox>
        <em>Tip:</em> Be creative! This is an opportunity to express yourself through code and design.
      </InfoBox>
    </div>
